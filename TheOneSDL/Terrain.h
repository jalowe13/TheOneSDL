...
public:
  ...
  void setTerrain(SDL_Rect *rect) { terrainList[terrainListSize] = rect; }

  // Sets the texture in the texture list
  void setText(SDL_Texture *texture) { textList[terrainListSize] = texture; }

  // Storage of Background Objects Rectangles
  SDL_Rect *getTerrain(int i) { return terrainList[i]; }

  // Get Texture in the Background Texture list
  SDL_Texture *getText(int i) { return textList[i]; }

  // Get "text" font, rectangle
  SDL_Rect *getTextRec(int i) { return textListRec[i]; }

  int getTextSize() { return textListSize; }

  int getTerrainSize() { return terrainListSize; }
  int getTerrainCap() { return terrainListCapacity; }
  ...
  SDL_Rect *getTerrainObj(int i) { return terrainObjList[i]; }
...
private:
  ...
  // Terrain Objects
  SDL_Rect
      *terrainObjList[terrainObjListCapacity]; // Storage of Terrain Objects
